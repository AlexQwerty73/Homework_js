...
class Controller {
    constructor() {
        ...
        this._bankCardNum = document.getElementById('bank-card');
        ...
        this._bankCardNumMess = document.getElementById('bank-card-mess');
    ...
    activatePass1() {
        this._pass1.addEventListener('blur', () => {
            ...
            if (this._validator.pass1IsValid) {
                ...
                this._pass1Mess.innerText = '\
                Пароль має бути не менше 8 символів, серед яких дозволено маленькі та великі літери або цифри, а також,\
                 - символ _, при чому має бути хоча б одна маленька літера, хоча б одна велика та хоча б одна цифра';
            }
        });
    }
    ...
    activateBankCardNum() {
        this._bankCardNum.addEventListener('blur', () => {
            this._validator.checkBankCardNum(this._bankCardNum.value);

            if (this._validator.bankCardNumIsValid) {
                this._bankCardNum.style.boxShadow = '0px 0px 10px green';
                this._bankCardNumMess.innerText = '';
            } else {
                this._bankCardNum.style.boxShadow = '0px 0px 10px red';
                this._bankCardNumMess.innerText = 'Номер карти має складатися з цифр';
            }
        });
    }
