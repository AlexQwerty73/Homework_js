...
class Validator {
    constructor() {
        ...
        this._bankCardNumIsValid = false;
    }

    get loginIsValid() { return this._loginIsValid }
    get pass1IsValid() { return this._pass1IsValid }
    get pass2IsValid() { return this._pass2IsValid }
    get emailIsValid() { return this._emailIsValid }
    get bankCardNumIsValid() { return this._bankCardNumIsValid }
    ...
    checkBankCardNum(bankCardNumValue) {
        let regularExpresion = /^[0-9]{1,}$/;
        this._bankCardNumIsValid = regularExpresion.test(bankCardNumValue);
    }

    checkAll = () => (this._loginIsValid && this._emailIsValid && this._pass1IsValid && this._pass2IsValid && this._bankCardNumIsValid);
}